...
struct PlayerComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &score, sizeof(int)); offset += sizeof(int);
        std::memcpy(data.data() + offset, &lives, sizeof(int)); offset += sizeof(int);
        std::memcpy(data.data() + offset, &shootCooldown, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &playerID, sizeof(int)); offset += sizeof(int);
    ...
    static PlayerComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.score, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.lives, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.shootCooldown, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.playerID, data + offset, sizeof(int)); offset += sizeof(int);
...
struct LaserWarningComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &appearanceTime, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &warningTime, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &activeTime, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &isActive, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(data.data() + offset, &warningShown, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(data.data() + offset, &width, sizeof(float)); offset += sizeof(float);
    ...
    static LaserWarningComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.appearanceTime, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.warningTime, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.activeTime, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.isActive, data + offset, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(&comp.warningShown, data + offset, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(&comp.width, data + offset, sizeof(float)); offset += sizeof(float);
...
struct SpriteComponent : public Component {
    ...
    static SpriteComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.width, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.height, data + offset, sizeof(int)); offset += sizeof(int);
...
struct ProjectileComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &damage, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &lifeTime, sizeof(float)); offset += sizeof(float);
        std::memcpy(data.data() + offset, &remainingLife, sizeof(float)); offset += sizeof(float);
    ...
    static ProjectileComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.damage, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.lifeTime, data + offset, sizeof(float)); offset += sizeof(float);
        std::memcpy(&comp.remainingLife, data + offset, sizeof(float)); offset += sizeof(float);
...
struct EnemyComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &type, sizeof(int)); offset += sizeof(int);
        std::memcpy(data.data() + offset, &shootingType, sizeof(int)); offset += sizeof(int);
        std::memcpy(data.data() + offset, &attackCooldown, sizeof(float)); offset += sizeof(float);
    ...
    static EnemyComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.type, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.shootingType, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.attackCooldown, data + offset, sizeof(float)); offset += sizeof(float);
...
struct PipeComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &isTopPipe, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(data.data() + offset, &gapHeight, sizeof(float)); offset += sizeof(float);
    ...
    static PipeComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.isTopPipe, data + offset, sizeof(bool)); offset += sizeof(bool);
        std::memcpy(&comp.gapHeight, data + offset, sizeof(float)); offset += sizeof(float);
...
struct GameStateComponent : public Component {
    ...
    std::vector<uint8_t> serialize() const {
        ...
        std::memcpy(data.data() + offset, &score, sizeof(int)); offset += sizeof(int);
        std::memcpy(data.data() + offset, &gameOver, sizeof(bool)); offset += sizeof(bool);
    ...
    static GameStateComponent deserialize(const uint8_t* data) {
        ...
        std::memcpy(&comp.score, data + offset, sizeof(int)); offset += sizeof(int);
        std::memcpy(&comp.gameOver, data + offset, sizeof(bool)); offset += sizeof(bool);
